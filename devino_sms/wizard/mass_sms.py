...
<form string="SMS Gateway - Send Devino SMS">
...
sms_send_fields = {
    ...
    'sender': {'string':'SMS Sender Name', 'type':'text', 'default':'DANCEVILLE', 'required':True}
}
...
def _sms_send(self, cr, uid, data, context):
    ...
    for r in res:
        ...
        if to:
            ...
            gateway.send_message(cr, uid, data['form']['gateway'], to, data['form']['sender'], message)
            nbr += 1
...
part_sms('res.partner.devino_sms_send.gateway')
